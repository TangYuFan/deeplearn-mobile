...
public class MainActivity extends CameraActivity{
    ...
    private int win_w = 384;private int win_h = 288;
//    private int win_w = 640;private int win_h = 640;
    ...
    private CameraBridgeViewBase.CvCameraViewListener2 cameraViewListener2 = new CameraBridgeViewBase.CvCameraViewListener2() {
        ...
        public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame frame) {
            ...
            // 推理并标注
//            OnnxUtil.inference1(mat,detection_p1,detection_p2); // java 预处理
            OnnxUtil.inference2(mat,detection_p1,detection_p2); // opencv 预处理
